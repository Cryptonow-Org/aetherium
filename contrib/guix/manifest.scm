...
(define* (make-aetherium-cross-toolchain  target
                                       #:key
...
desirable for building Aetherium release binaries."
...
(packages->manifest
 (append
  (list ;; The Basics
        ...
        python-minimal ; required to build aetherium (cmake/CheckTrezor.cmake) and in android_ndk
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-gnu")
           (list
             ...
             (make-aetherium-cross-toolchain target)))
