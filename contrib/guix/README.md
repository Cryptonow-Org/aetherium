# Bootstrappable Aetherium Builds

This directory contains the files necessary to perform bootstrappable Aetherium 
builds.
...
To build Aetherium reproducibly with all default options, invoke the
...
repository](https://github.com/aetherium-project/guix.sigs).
