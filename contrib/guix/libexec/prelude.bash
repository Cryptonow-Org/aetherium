...
#
# - Push new commits to aetherium-project/guix from upstream. Do not forget to update
#   the keyring branch as well. Guix uses this branch to authenticate commits.
#
#   The repository is set to aetherium-project/guix because fetching from the official
#   repo at https://git.savannah.gnu.org/git/guix.git is unreliable in CI jobs.
#
#   Do not attempt to push custom changes to aetherium-project/guix, it will not work!
...
time-machine() {
    ...
    guix time-machine --url=https://github.com/aetherium-project/guix.git \
