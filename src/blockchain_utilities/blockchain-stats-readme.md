# Aetherium Blockchain Stats

Aetherium Blockchain Stats utlity exports daily statistics for the aetherium blockchain from creation through current state.

## Usage:

See also the utility's help option. `aetherium-blockchain-stats --help`
...
- `aetherium-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `aetherium-blockchain-stats | save-to-database.sh`
